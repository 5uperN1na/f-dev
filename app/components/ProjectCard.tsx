...
const ProjectCard = ({ project }: { project: Project }) => {
  return (
    ...
    >
      <div
        key={project.id}
        className="div bg-gray-800 border border-gray-700 rounded-lg overflow-hidden shadow-sm transition hover:shadow-md"
      >
        <img
          src={project.image}
          alt={project.title}
        ...
        <div className="p-5">
          ...
          <div className="div flex justify-between items-center text-sm text-gray-400">
